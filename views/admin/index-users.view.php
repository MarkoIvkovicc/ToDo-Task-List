            ...
            <div>
                <div class="w-full bg-white shadow-lg rounded-lg overflow-hidden my-4">
                    ...
                    <div class="flex items-center px-6 py-3 bg-teal-800">
                        ...
                        <h1 class="mx-3 text-white font-semibold text-lg"><?= ucfirst($user->role) ?></h1>

                    </div>
                    <div class="py-4 px-6">
                        <div class="flex">
                            <h1 class="text-2xl font-semibold text-gray-800"><?= ucfirst($user->name) ?></h1>
                            <a href="showUser?id=<?= $user->id ?>" class="ml-auto shadow bg-teal-600 hover:bg-teal-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded">View User</a>
                        </div>
                    ...
                    <div class="mb-2">
                        <form action="updateUser?id=<?= $user->id ?>">
